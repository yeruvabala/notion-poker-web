...
exports.getBucketStrategy = getBucketStrategy;
// =============================================================================
// CONSTANTS
// =============================================================================
const RANK_VALUES = {
 ...
 */
function evaluateMadeHand(heroCards, boardCards) {
    ...
    if (pairs.length >= 2) {
        ...
        const heroPairs = pairs.filter(([rank]) => heroRanks.includes(parseInt(rank)));
 ...
 */
function evaluateDraws(heroCards, boardCards) {
    const draws = [];
    const allCards = [...heroCards, ...boardCards];
    const heroRanks = heroCards.map(c => c.rankValue);
 ...
 */
function classifyHand(heroHand, board) {
 ...
 */
function getBucketStrategy(classification) {
