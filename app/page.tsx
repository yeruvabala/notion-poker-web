...
/** Shape we use throughout the page */
type Fields = {
  date?: string | null;                 // not shown in UI; tags row replaces date
  stakes?: string | null;               // TEXT, not number
  position?: string | null;
  cards?: string | null;
  villain_action?: string | null;
  villian_action?: string | null;       // tolerate typo in upstream
...
/** Helper: coerce any value into clean, readable text */
  ...
  async function analyzeParsedHand(parsed: Fields) {
    ...
    try {
      const payload = {
        ...
        stakes: parsed.stakes ?? undefined,                // TEXT
          ...
          <div className="col right">
            <div className="card">
              <div className="row spaceBetween">
                <TagChips />
                <div className="meta">
                  {/* top-right hand meta — keeps existing “1/3 • A4s” style */}
...
/** Small helper component for the right panel rows */
