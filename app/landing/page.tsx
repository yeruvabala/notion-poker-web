                ...
                <div className="container">
                    <div className="download-content">
                        ...
                        <div className="download-buttons">
                            <a href="https://apps.apple.com/us/app/onlypoker/id6758497301" target="_blank" rel="noopener noreferrer" className="download-btn ios">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.onlypoker.app" target="_blank" rel="noopener noreferrer" className="download-btn android">
                                <div className="btn-icon">
                                    <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
